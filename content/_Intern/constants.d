...
const int GIL_MILITIA = 1;
const int GIL_WORKER = 2;
const int GIL_MINER = 3;
const int GIL_HEALER = 4;
const int GIL_THIEF = 5;
const int GIL_POSSESSED = 6;
const int GIL_BEGGAR = 7;
const int GIL_DEMONIC = 8;
const int GIL_AMAZON = 9;
const int GIL_PALADIN = 10;
const int GIL_KDF = 11;
const int GIL_BLOODEARTH = 12;
...
const int TEXT_WIDTH_AIOUTPUT = 290;
const int TEXT_WIDTH_SVM = 290;
const int TEXT_WIDTH_CINFODESCRIPTION = 63;
const int TEXT_WIDTH_INFOADDCHOICE = 63;
const int TEXT_WIDTH_NAME = 30;
const int TEXT_WIDTH_TEXT = 41;
const int TEXT_WIDTH_TEXT_MENU_0 = 15;
const int TEXT_WIDTH_TEXT_MENU_1 = 40;
const int TEXT_WIDTH_DESCRIPTION = 45;
const int TEXT_WIDTH_LOGCONSTANTS = 35;
const int TEXT_WIDTH_CONSTANTS = 62;
