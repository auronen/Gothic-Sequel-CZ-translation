...
const int HP_Essenz = 100;
const int Value_HpExtrakt = 50;
const int HP_Extrakt = 200;
const int Value_HpElixier = 125;
const int HP_Elixier = 500;
const int Value_ManaEssenz = 25;
const int Mana_Essenz = 50;
const int Value_ManaExtrakt = 50;
const int Mana_Extrakt = 100;
const int Value_ManaElixier = 125;
const int Mana_Elixier = 250;
const int Value_Haste1 = 25;
const int Time_Haste1 = 60000;
const int Value_Haste2 = 50;
const int Time_Haste2 = 120000;
const int Value_Haste3 = 125;
...
instance ItFo_Potion_Master_01(C_Item)
{
	...
	change_atr[0] = ATR_DEXTERITY;
	change_value[0] = StrDex_Macht;
	text[2] = NAME_Bonus_Str;
	count[2] = StrDex_Macht;
	change_atr[1] = ATR_STRENGTH;
	change_value[1] = StrDex_Macht;
	text[5] = NAME_Value;
...
instance ItFo_Potion_Master_02(C_Item)
{
	...
	change_atr[0] = ATR_DEXTERITY;
	change_value[0] = StrDex_Herrschaft;
	text[2] = NAME_Bonus_Str;
	count[2] = StrDex_Herrschaft;
	change_atr[1] = ATR_STRENGTH;
	change_value[1] = StrDex_Herrschaft;
	text[5] = NAME_Value;
...
instance ItFo_Potion_Mana_Perma_02(C_Item)
{
	...
	change_atr[0] = ATR_MANA_MAX;
	change_value[0] = ManaMax_Extrakt;
	text[5] = NAME_Value;
...
instance ItFo_Potion_Mana_Perma_03(C_Item)
{
	...
	change_atr[0] = ATR_MANA_MAX;
	change_value[0] = ManaMax_Elixier;
	text[5] = NAME_Value;
