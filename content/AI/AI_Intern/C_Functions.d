...
func int C_NpcIsDangerousMonster(var C_Npc slf,var C_Npc oth)
{
	...
	if(C_NpcIsMonster(oth) && (Wld_GetGuildAttitude(oth.guild,slf.guild) == ATT_HOSTILE) && !oth.aivar[23] && !C_NpcIsDown(oth))
	{
		PrintDebugNpc(PD_ZS_DETAIL,"...true");
		return TRUE;
	};
...
func int C_NpcIsGuard(var C_Npc slf)
{
	...
	if((slf.npcType == npctype_guard) || (slf.npcType == NpcType_MINE_Guard) || (((slf.npcType == npctype_main) || (slf.npcType == npctype_friend)) && (slf.guild == GIL_MILITIA)))
	{
