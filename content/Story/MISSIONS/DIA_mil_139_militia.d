...
{
	if(Npc_IsInRoutine(self,zs_guardfp) && (Npc_GetDistToWP(self,"OCR_OUTSIDE_CAMPFIRE_D_1") <= 700) && !Npc_KnowsInfo(hero,mil_129_militia_stop) && !Npc_KnowsInfo(hero,mil_130_militia_stop) && !Npc_KnowsInfo(hero,mil_140_militia_stop))
	{
		return TRUE;
	};
};
