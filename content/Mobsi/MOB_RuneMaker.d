...
instance MOB_Runemaker_Light (c_Info)
{
	...
	important		= FALSE;
	permanent		= TRUE;
	description		= B_BuildRunemakerString(	NAME_Light,
												NAME_Rune,
												ManaPerm_RuneLight			);
};
...
instance MOB_Runemaker_Firebolt (c_Info)
{
	...
	important		= FALSE;
	permanent		= TRUE;
	description		= B_BuildRunemakerString(	NAME_Firebolt,
												NAME_Rune,
												ManaPerm_RuneFirebolt		);
};
...
instance MOB_Runemaker_Heal (c_Info)
{
	...
	important		= FALSE;
	permanent		= TRUE;
	description		= B_BuildRunemakerString(	NAME_Heal,
												NAME_Rune,
												ManaPerm_RuneHeal		);
};
...
instance MOB_Runemaker_Thunderbolt (c_Info)
{
	...
	important		= FALSE;
	permanent		= TRUE;
	description		= B_BuildRunemakerString(	NAME_Thunderbolt,
												NAME_Rune,
												ManaPerm_RuneThunderbolt		);
};
...
instance MOB_Runemaker_Windfist (c_Info)
{
	...
	important		= FALSE;
	permanent		= TRUE;
	description		= B_BuildRunemakerString(	NAME_Windfist,
												NAME_Rune,
												ManaPerm_RuneWindfist		);
};
...
instance MOB_Runemaker_Sleep (c_Info)
{
	...
	important		= FALSE;
	permanent		= TRUE;
	description		= B_BuildRunemakerString(	NAME_Sleep,
												NAME_Rune,
												ManaPerm_RuneSleep		);
};
...
instance MOB_Runemaker_Charm (c_Info)
{
	...
	important		= FALSE;
	permanent		= TRUE;
	description		= B_BuildRunemakerString(	NAME_Charm,
												NAME_Rune,
												ManaPerm_RuneCharm		);
};
...
instance MOB_Runemaker_Thunderball (c_Info)
{
	...
	important		= FALSE;
	permanent		= TRUE;
	description		= B_BuildRunemakerString(	NAME_Thunderball,
												NAME_Rune,
												ManaPerm_RuneThunderball		);
};
...
instance MOB_Runemaker_Icecube (c_Info)
{
	...
	important		= FALSE;
	permanent		= TRUE;
	description		= B_BuildRunemakerString(	NAME_Icecube,
												NAME_Rune,
												ManaPerm_RuneIcecube		);
};
...
instance MOB_Runemaker_Pyrokinesis (c_Info)
{
	...
	important		= FALSE;
	permanent		= TRUE;
	description		= B_BuildRunemakerString(	NAME_Pyrokinesis,
												NAME_Rune,
												ManaPerm_RunePyrokinesis		);
};
...
instance MOB_Runemaker_DestroyUndead (c_Info)
{
	...
	important		= FALSE;
	permanent		= TRUE;
	description		= B_BuildRunemakerString(	NAME_Destroyundead,
												NAME_Rune,
												ManaPerm_RuneDestroyUndead		);
};
...
instance MOB_Runemaker_Chainlightning (c_Info)
{
	...
	important		= FALSE;
	permanent		= TRUE;
	description		= B_BuildRunemakerString(	NAME_Chainlightning,
												NAME_Rune,
												ManaPerm_RuneChainlightning		);
};
...
instance MOB_Runemaker_Stormfist (c_Info)
{
	...
	important		= FALSE;
	permanent		= TRUE;
	description		= B_BuildRunemakerString(	NAME_Stormfist,
											NAME_Rune,
											ManaPerm_RuneStormfist		);
};
...
instance MOB_Runemaker_Telekinesis (c_Info)
{
	...
	important		= FALSE;
	permanent		= TRUE;
	description		= B_BuildRunemakerString(	NAME_Telekinesis,
												NAME_Rune,
												ManaPerm_RuneTelekinesis		);
};
...
instance MOB_Runemaker_Fireball (c_Info)
{
	...
	important		= FALSE;
	permanent		= TRUE;
	description		= B_BuildRunemakerString(	NAME_Fireball,
												NAME_Rune,
												ManaPerm_RuneFireball		);
};
...
instance MOB_Runemaker_FireStorm (c_Info)
{
	...
	important		= FALSE;
	permanent		= TRUE;
	description		= B_BuildRunemakerString(	NAME_FireStorm,
												NAME_Rune,
												ManaPerm_RuneFireStorm		);
};
...
instance MOB_Runemaker_Control (c_Info)
{
	...
	important		= FALSE;
	permanent		= TRUE;
	description		= B_BuildRunemakerString(	NAME_Control,
												NAME_Rune,
												ManaPerm_RuneControl		);
};
...
instance MOB_Runemaker_BreathOfDeath (c_Info)
{
	...
	important		= FALSE;
	permanent		= TRUE;
	description		= B_BuildRunemakerString(	NAME_BreathOfDeath,
												NAME_Rune,
												ManaPerm_RuneBreathOfDeath		);
};
...
instance MOB_Runemaker_Icewave (c_Info)
{
	...
	important		= FALSE;
	permanent		= TRUE;
	description		= B_BuildRunemakerString(	NAME_Icewave,
												NAME_Rune,
												ManaPerm_RuneIcewave		);
};
...
instance MOB_Runemaker_Firerain (c_Info)
{
	...
	important		= FALSE;
	permanent		= TRUE;
	description		= B_BuildRunemakerString(	NAME_Firerain,
												NAME_Rune,
												ManaPerm_RuneFirerain		);
};
