...
//  ISaidStopMagic              =   "SVM_1_ISaidStopMagic"              ;//Willst du Schläge? Hör sofort damit auf!!!
    ISaidStopMagic              =   "SVM_1_ISaidStopMagic"              ;//Chceš flákanec? Okamžitě toho nech!
...
//  DieMonster                  =   "SVM_1_DieMonster"                  ;//Verdammtes Drecksvieh!
    DieMonster                  =   "SVM_1_DieMonster"                  ;//Zatracená bestie!
...
//  ITookYourOre                =   "SVM_1_ITookYourOre"                ;//Danke für das Silber, du Held!
    ITookYourOre                =   "SVM_1_ITookYourOre"                ;//Díky za to stříbro, hrdino!
...
//  WhyAreYouSneaking           =   "SVM_1_WhyAreYouSneaking"           ;//Hey du! Was schleichst du da rum.
    WhyAreYouSneaking           =   "SVM_1_WhyAreYouSneaking"           ;//Hej! Jak ses sem dostal?
//  GetOutOrICallGuards         =   "SVM_1_GetOutOrICallGuards"         ;//Raus aus meiner Hütte oder ich ruf die Wachen!
    GetOutOrICallGuards         =   "SVM_1_GetOutOrICallGuards"         ;//Vypadni z mojí chatrče nebo zavolám stráže!
...
//  CallGuards                  =   "SVM_1_CallGuards"                  ;//Wachen! Hierher!
    CallGuards                  =   "SVM_1_CallGuards"                  ;//Stráže! Sem!
...
//  SectGreetings               =   "SVM_1_SectGreetings"               ;//Erwache!
    SectGreetings               =   "SVM_1_SectGreetings"               ;//Buď probuzen!
//  NoLearnNoPoints             =   "SVM_1_NoLearnNoPoints"             ;//Komm wieder, wenn du mehr Erfahrung hast.
    NoLearnNoPoints             =   "SVM_1_NoLearnNoPoints"             ;//Vrať se, až budeš mít víc zkušeností.
...
//  NoLearnYouAlreadyKnow       =   "SVM_1_NoLearnYouAlreadyKnow"       ;//Du musst erst fortgeschritten sein, bevor du Meister werden kannst!
    NoLearnYouAlreadyKnow       =   "SVM_1_NoLearnYouAlreadyKnow"       ;//Aby ses mohl stát mistrem, musíš na sobě ještě pracovat!
...
//  MakeWay                     =   "SVM_1_MakeWay"                     ;//Lass mich mal vorbei!
    MakeWay                     =   "SVM_1_MakeWay"                     ;//Nech mě projít!
...
//  YouStoleFromMe              =   "SVM_1_YouStoleFromMe"              ;//Du Arsch hast mich beklaut!
    YouStoleFromMe              =   "SVM_1_YouStoleFromMe"              ;//Ty hajzle, tys mě okradl!
//  YouAttackedMe               =   "SVM_1_YouAttackedMe"               ;//Warum hast du mich angegriffen??
    YouAttackedMe               =   "SVM_1_YouAttackedMe"               ;//Proč jis mě napadl?
...
//  YouDisturbedArenaFight      =   "SVM_1_YouDisturbedArenaFight"      ;//Du spinnst wohl. Kannst doch nicht einfach einen Arenakampf unterbrechen.
    YouDisturbedArenaFight      =   "SVM_1_YouDisturbedArenaFight"      ;//Jsi úplný blázen. Nemůžeš takhle přerušit souboj v aréně.
//  YouMurderedInArena          =   "SVM_1_YouMurderedInArena"          ;//Bist du wahnsinnig. In der Arena wird nicht getötet!
    YouMurderedInArena          =   "SVM_1_YouMurderedInArena"          ;//Ty ses zbláznil?! V aréně nesmí nikdo zabíjet!
//  NoMagicInArena              =   "SVM_1_NoMagicInArena"              ;//Keine Magie in der Arena. Das ist Gesetz!
    NoMagicInArena              =   "SVM_1_NoMagicInArena"              ;//V aréně se nesmí kouzlit. Takový je zákon!
//  NoBowInArena                =   "SVM_1_NoBowInArena"                ;//Keine Fernkampfwaffen in der Arena! Weg damit!
    NoBowInArena                =   "SVM_1_NoBowInArena"                ;//V aréně nesmíš používat zbraně na dálku! Pryč s nimi!
//  PointForYou                 =   "SVM_1_PointForYou"                 ;//Punkt für dich!
    PointForYou                 =   "SVM_1_PointForYou"                 ;//Bod pro tebe!
//  PointForMe                  =   "SVM_1_PointForMe"                  ;//Punkt für mich!
    PointForMe                  =   "SVM_1_PointForMe"                  ;//Bod pro mě!
//  Buh                         =   "SVM_1_Buh"                         ;//BUUHHH!!!!
    Buh                         =   "SVM_1_Buh"                         ;//BŮŮŮŮŮŮŮŮ!
//  NotEnoughSilver             =   "SVM_1_NotEnoughSilver"             ;//Du hast ja garnicht genug Silber, um zu bezahlen!
    NotEnoughSilver             =   "SVM_1_NotEnoughSilver"             ;//Nemáš dostatek stříbra k zaplacení!
//  Possessed1                  =   "SVM_1_Possessed1"                  ;//Die Sonne wird den Mond fressen
    Possessed1                  =   "SVM_1_Possessed1"                  ;//Slunce sežere měsíc
//  Possessed2                  =   "SVM_1_Possessed2"                  ;//Ein großer Aschtopf wird vom Himmel fallen
    Possessed2                  =   "SVM_1_Possessed2"                  ;//Z nebe spadne velký popelník
};
...
//  YouDisturbedArenaFight      =   "SVM_2_YouDisturbedArenaFight"      ;//Du spinnst wohl. Kannst doch nicht einfach einen Arenakampf unterbrechen.
    YouDisturbedArenaFight      =   "SVM_2_YouDisturbedArenaFight"      ;//Zbláznil ses? Nemůžeš jen tak přerušit souboj v aréně.
//  YouMurderedInArena          =   "SVM_2_YouMurderedInArena"          ;//Bist du wahnsinnig. In der Arena wird nicht getötet!
    YouMurderedInArena          =   "SVM_2_YouMurderedInArena"          ;//Jsi šílenec? V aréně se nezabíjí!
//  NoMagicInArena              =   "SVM_2_NoMagicInArena"              ;//Keine Magie in der Arena. Das ist Gesetz!
    NoMagicInArena              =   "SVM_2_NoMagicInArena"              ;//Žádná magie v aréně. To je zákon!
//  NoBowInArena                =   "SVM_2_NoBowInArena"                ;//Keine Fernkampfwaffen in der Arena! Weg damit!
    NoBowInArena                =   "SVM_2_NoBowInArena"                ;//V aréně nesmíš používat zbraně na dálku! Pryč s ní!
//  PointForYou                 =   "SVM_2_PointForYou"                 ;//Punkt für dich!
    PointForYou                 =   "SVM_2_PointForYou"                 ;//Bod pro tebe!
//  PointForMe                  =   "SVM_2_PointForMe"                  ;//Punkt für mich!
    PointForMe                  =   "SVM_2_PointForMe"                  ;//Bod pro mě!
...
//  NotEnoughSilver             =   "SVM_2_NotEnoughSilver"             ;//Kann es sein, dass du garnicht genug Silber hast?
    NotEnoughSilver             =   "SVM_2_NotEnoughSilver"             ;//Je možné, že nemáš dostatek stříbrných?
//  Buh                         =   "SVM_2_Buh"                         ;//BUUHHH!!!!
    Buh                         =   "SVM_2_Buh"                         ;//BŮŮŮŮŮŮŮŮ!
//  Possessed1                  =   "SVM_2_Possessed1"                  ;//Arbeit, Leben, Tod
    Possessed1                  =   "SVM_2_Possessed1"                  ;//Práce, život, smrt
//  Possessed2                  =   "SVM_2_Possessed2"                  ;//Tod wird gemrntg
    Possessed2                  =   "SVM_2_Possessed2"                  ;//Smrt pracuje rychle
};
...
//  Smalltalk24                 =   "SVM_6_Smalltalk24"                 ;// ... lass uns lieber über was anderes reden ...
    Smalltalk01                 =   "SVM_6_Smalltalk01"                 ;// ...když myslíš...
    Smalltalk02                 =   "SVM_6_Smalltalk02"                 ;// ...možná...
    ...
    Smalltalk07                 =   "SVM_6_Smalltalk07"                 ;// ...nech si to ale pro sebe, lidé to nemusí vědět...
...
//  Smalltalk24                 =   "SVM_11_Smalltalk24"                    ;// ... lass uns lieber über was anderes reden ...
    ...
    Smalltalk07                 =   "SVM_11_Smalltalk07"                    ;// ...nech si to ale pro sebe, lidé to nemusí vědět...
...
//    Possessed2                  =   "SVM_14_Possessed2"                     ;//Braue den finalen Traaaank
    YouDisturbedArenaFight      =   "SVM_14_YouDisturbedArenaFight"     ;//Jsi úplný blázen. Nemůžeš takhle přerušit souboj v aréně.
    YouMurderedInArena          =   "SVM_14_YouMurderedInArena"         ;//Ty ses zbláznil?! V aréně nesmí nikdo zabíjet!
    NoBowInArena                =   "SVM_14_NoBowInArena"               ;//V aréně nesmíš používat zbraně na dálku! Pryč s ní!
    NoMagicInArena              =   "SVM_14_NoMagicInArena"             ;//V aréně se nesmí kouzlit. Takový je zákon!
    PointForYou                 =   "SVM_14_PointForYou"                ;//Bod pro tebe!
    PointForMe                  =   "SVM_14_PointForMe"                 ;//Bod pro mě!  
    NotEnoughSilver             =   "SVM_14_NotEnoughSilver"            ;//Je možné, že nemáš dostatek stříbrných?
    Possessed1                  =   "SVM_14_Possessed1"                 ;//Musím najít své věci
    Buh                         =   "SVM_14_Buh"                        ;//BŮŮŮŮŮŮŮŮ!
    Possessed2                  =   "SVM_14_Possessed2"                 ;//Chodí sami
};
...
//  MageGreetings               =   "SVM_15_MageGreetings"              ;//Sei gegrüßt!
    MageGreetings               =   "SVM_15_MageGreetings"              ;//Buď pozdraven!
//  FriendlyGreetings           =   "SVM_15_FriendlyGreetings"          ;//Hi!
    FriendlyGreetings           =   "SVM_15_FriendlyGreetings"          ;//Ahoj!
...
//  WaterpipeVision1            =   "SVM_15_WaterpipeVision1"           ;// ... Xardas wird das Land erhellen ...
    WaterpipeVision1            =   "SVM_15_WaterpipeVision1"           ;// ...Xardas osvítí celou zemi...
//  WaterpipeVision2            =   "SVM_15_WaterpipeVision2"           ;// ... Nimm Dich in Acht vor den Amazonen ...
    WaterpipeVision2            =   "SVM_15_WaterpipeVision2"           ;// ...dej si pozor na Amazonky...
//  WaterpipeVision3            =   "SVM_15_WaterpipeVision3"           ;// ... Nicht alle Orks sind von Grund auf böse ...
    WaterpipeVision3            =   "SVM_15_WaterpipeVision3"           ;// ...ne všichni skřeti jsou zlí...
//  WaterpipeVision4            =   "SVM_15_WaterpipeVision4"           ;// ... Feuerregen wird über das Land kommen ...
    WaterpipeVision4            =   "SVM_15_WaterpipeVision4"           ;// ...na zem bude padat ohnivý déšť...
//  WaterpipeVision5            =   "SVM_15_WaterpipeVision5"           ;// ... Bist Du nicht der Auserwählte ...
    WaterpipeVision5            =   "SVM_15_WaterpipeVision5"           ;// ...nejsi vyvolený...
...
//  Possessed2                  =   "SVM_16_Possessed2"                 ;//Sie laufen von allein.
    ...
    YouDisturbedArenaFight      =   "SVM_16_YouDisturbedArenaFight"     ;//Jsi úplný blázen. Nemůžeš takhle přerušit souboj v aréně.
    YouMurderedInArena          =   "SVM_16_YouMurderedInArena"         ;//Ty ses zbláznil?! V aréně nesmí nikdo zabíjet!
    NoBowInArena                =   "SVM_16_NoBowInArena"               ;//V aréně nesmíš používat zbraně na dálku! Pryč s ní!
    NoMagicInArena              =   "SVM_16_NoMagicInArena"             ;//V aréně se nesmí kouzlit. Takový je zákon!
    PointForYou                 =   "SVM_16_PointForYou"                ;//Bod pro tebe!
    PointForMe                  =   "SVM_16_PointForMe"                 ;//Bod pro mě!  
    NotEnoughSilver             =   "SVM_16_NotEnoughSilver"            ;//Je možné, že nemáš dostatek stříbrných?
    Possessed1                  =   "SVM_16_Possessed1"                 ;//Musím najít své věci
    Buh                         =   "SVM_16_Buh"                        ;//BŮŮŮŮŮŮŮŮ!
    Possessed2                  =   "SVM_16_Possessed2"                 ;//Chodí sami
};
