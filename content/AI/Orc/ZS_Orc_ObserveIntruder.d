...
func int ZS_OrcGuard_ObserveIntruder_Loop()
{
	...
	else if((Npc_GetAttitude(self,other) == ATT_NEUTRAL) && (self.aivar[18] == 0))
	{
		PrintDebugNpc(PD_ORC_FRAME,"ZS_OrcGuard_ObserveIntruder: NEUTRAL");
		B_Orc_SmartTurn();
		if((Npc_GetDistToNpc(self,other) < 300) && (self.aivar[17] > 0))
		{
			if(self.aivar[17] != 2)
			{
				self.aivar[17] = 2;
		...
		else if((Npc_GetDistToNpc(self,other) < 500) && (self.aivar[17] == 0))
		{
			self.aivar[17] = 1;
	...
	else if(Npc_GetAttitude(self,other) == ATT_FRIENDLY)
	{
		...
		B_Orc_SmartTurn();
		if((Npc_GetDistToNpc(self,other) < 300) && (self.aivar[17] != 1))
		{
			self.aivar[17] = 1;
...
func int ZS_OrcScout_ObserveIntruder_Loop()
{
	...
	else if((Npc_GetAttitude(self,other) == ATT_ANGRY) && (self.aivar[18] == 0))
	{
		...
		B_Orc_SmartTurn();
		if((Npc_GetDistToNpc(self,other) < 300) && ((self.aivar[17] == 1) || (Npc_GetStateTime(self) > 6)))
		{
			PrintDebugNpc(PD_ORC_FRAME,"ZS_OrcScout_ObserveIntruder: ANGRY: Angriff 1");
			B_Say(self,other,"$DIE");
			AI_StartState(self,ZS_Orc_Attack,1,"");
		}
		else if((Npc_GetDistToNpc(self,other) < 400) && (self.aivar[17] == 0))
		{
	...
	else if((Npc_GetAttitude(self,other) == ATT_NEUTRAL) && (self.aivar[18] == 0))
	{
		...
		B_Orc_SmartTurn();
		if((Npc_GetDistToNpc(self,other) < 200) && (self.aivar[17] > 0))
		{
			if(self.aivar[17] != 2)
			{
				self.aivar[17] = 2;
...
func int ZS_OrcShaman_ObserveIntruder_Loop()
{
	...
	else if((Npc_GetAttitude(self,other) == ATT_NEUTRAL) && (self.aivar[18] == 0))
	{
		...
		else if((Npc_GetDistToNpc(self,other) < 1000) && (self.aivar[17] == 0))
		{
			self.aivar[17] = 1;
