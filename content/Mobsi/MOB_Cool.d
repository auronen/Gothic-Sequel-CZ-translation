...
instance MOB_Cool_SWORDBLADE (c_Info)
{
	...
	important		= FALSE;
	permanent		= TRUE;
	description		= B_BuildCoolString(	NAME_HotSwordblade,
											NAME_Ore,
											NAME_Swordblade	);
};
...
instance MOB_Cool_2HSwordblade (c_Info)
{
	...
	important		= FALSE;
	permanent		= TRUE;
	description		= B_BuildCoolString(	NAME_Hot2HSwordblade,
											NAME_Ore,
											NAME_2HSwordblade	);
};
...
instance MOB_Cool_Axeblade (c_Info)
{
	...
	important		= FALSE;
	permanent		= TRUE;
	description		= B_BuildCoolString(	NAME_HotAxeblade,
											NAME_Ore,
											NAME_Axeblade	);
};
...
instance MOB_Cool_2HAxeblade (c_Info)
{
	...
	important		= FALSE;
	permanent		= TRUE;
	description		= B_BuildCoolString(	NAME_Hot2HAxeblade,
											NAME_Ore,
											NAME_2HAxeblade	);
};
...
instance MOB_Cool_Stump (c_Info)
{
	...
	important		= FALSE;
	permanent		= TRUE;
	description		= B_BuildCoolString(	NAME_HotStump,
											NAME_Ore,
											NAME_Stump	);
};
...
instance MOB_Cool_2HStump (c_Info)
{
	...
	important		= FALSE;
	permanent		= TRUE;
	description		= B_BuildCoolString(	NAME_Hot2HStump,
											NAME_Ore,
											NAME_2HStump	);
};
