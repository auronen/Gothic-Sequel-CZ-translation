...
func void ZS_Smoke ()
{
	...
	{
		AI_UseMob			(self,	SCEMENAME_WATERPIPE,1);	// Benutze den Mob einmal bis zum angegebenen State
	}
	else
	{
		B_GotoFP (self, "STAND");
...
func void ZS_Smoke_End ()
{
	...
	{
		AI_UseMob			(self,	SCEMENAME_WATERPIPE,	-1);			// Lösen vom Mobsi bei verlassen des Zustandes, wegen Zeit oder Reaktion
	};	
};
